        ...
        <div className='flex justify-center'>
            <div className='w-full md:w-10/12 lg:w-8/12'>
                ...
                <div className='py-4 w-full bg-[#E8F2FF] rounded-xl flex justify-center items-center flex-col'>
                    ...
                    <p className='text-[#8B9199] text-sm'>{amount}</p>
                </div>
                ...
                <div>
                    ...
                    <div className='flex items-center gap-3 pb-3 flex-wrap'>
                        ...
                        <button><Icon icon='mynaui:copy' className='text-[#177DFF] text-lg' /></button>
                    </div>
                    ...
                    <div className='flex justify-center pt-16 lg:pt-24 pb-5'>
                        <button className='bg-[#1992C9] text-white py-5 rounded-xl w-full md:w-max px-16 flex items-center justify-center'>Done</button>
                    </div>
                </div>
            </div>
        </div>
